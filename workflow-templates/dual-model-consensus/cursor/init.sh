...
main() {
  ...
  copy_file "${CURSOR_DIR}/skill/SKILL.md" "${target_project}/.cursor/skills/dual-model-consensus/SKILL.md"
  copy_file "${COMMON_DIR}/reference.md" "${target_project}/.cursor/skills/dual-model-consensus/reference.md"
  copy_file "${COMMON_DIR}/prompts/claude-analysis-planner.md" "${target_project}/.cursor/prompts/dual-model-consensus/claude-analysis-planner.md"
  copy_file "${COMMON_DIR}/prompts/gpt-review.md" "${target_project}/.cursor/prompts/dual-model-consensus/gpt-review.md"
  copy_file "${COMMON_DIR}/prompts/claude-revision.md" "${target_project}/.cursor/prompts/dual-model-consensus/claude-revision.md"
  copy_file "${COMMON_DIR}/prompts/disagreement-report.md" "${target_project}/.cursor/prompts/dual-model-consensus/disagreement-report.md"
  copy_file "${COMMON_DIR}/prompts/claude-code-draft.md" "${target_project}/.cursor/prompts/dual-model-consensus/claude-code-draft.md"
  copy_file "${COMMON_DIR}/prompts/gpt-code-review.md" "${target_project}/.cursor/prompts/dual-model-consensus/gpt-code-review.md"
  copy_file "${COMMON_DIR}/prompts/claude-code-revision.md" "${target_project}/.cursor/prompts/dual-model-consensus/claude-code-revision.md"
  copy_file "${CURSOR_DIR}/agents/claude-author.md" "${target_project}/.cursor/agents/claude-author.md"
  copy_file "${CURSOR_DIR}/agents/gpt-reviewer.md" "${target_project}/.cursor/agents/gpt-reviewer.md"

  upsert_agents_block "${target_project}/AGENTS.md"

  echo "已初始化 Cursor 版双模型共识工作流:"
