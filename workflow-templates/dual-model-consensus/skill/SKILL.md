...
- prompt 模板：`../../prompts/dual-model-consensus/claude-code-draft.md`
- 修订模板：`../../prompts/dual-model-consensus/claude-code-revision.md`
...
- prompt 模板：`../../prompts/dual-model-consensus/gpt-code-review.md`
